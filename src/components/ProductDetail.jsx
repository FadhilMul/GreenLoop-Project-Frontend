...
const ProductDetail = () => {
  ...
  const photoGallery = [
    ...
    {
      id: 3,
      url: "https://images.unsplash.com/photo-1515344905723-babc01aac23d",
  ...
  const videoGallery = [
    ...
    },
    {
      ...
      thumbnail: "https://images.unsplash.com/photo-1542800952-e5471ed41326",
      duration: "5:12",
      type: "showcase",
    },
    {
      ...
      thumbnail: "https://images.unsplash.com/photo-1594058573823-d8edf1ad3380",
      duration: "4:35",
      type: "process",
    },
  ];
      ...
      ? [
          {
            ...
            description:
              "Choose a spot with good drainage and prepare the soil by loosening it to about 2-3 inches deep.",
            image:
              "https://images.pexels.com/photos/886521/pexels-photo-886521.jpeg",
          },
          {
            step: 2,
            title: "Plant the seed paper",
            description:
              "Place the seed paper on the soil surface. You can tear it into smaller pieces if needed.",
            image: product.image,
          },
          {
            step: 3,
            title: "Cover lightly",
            description:
              "Sprinkle a thin layer of soil over the seed paper, just enough to barely cover it.",
            image:
          ...
          },
          {
            ...
            title: "Water gently",
            description:
              "Water the area gently but thoroughly. Keep the soil moist but not waterlogged.",
            image:
              "https://images.unsplash.com/photo-1515344905723-babc01aac23d",
          },
          {
            step: 5,
            title: "Wait and watch",
            description:
              "Seeds typically germinate within 1-3 weeks. Continue watering regularly and watch your plants grow!",
            image:
              "https://images.pexels.com/photos/886521/pexels-photo-886521.jpeg",
          },
        ]
      : [
          {
            ...
            description:
              "Select clean, dry items you want to store. The pouch is perfect for small accessories, stationery, or eco-friendly products.",
            image: product.image,
          },
          {
            step: 2,
            ...
            description:
              "The upcycled design makes each pouch unique. Use the natural compartments and textures to organize different types of items.",
            image:
              "https://images.unsplash.com/photo-1594058573823-d8edf1ad3380",
          },
          {
            step: 3,
            title: "Care and maintenance",
            description:
              "Clean with a damp cloth when needed. The upcycled materials are durable but should be kept away from excessive moisture.",
          ...
          },
          {
            ...
            description:
              "Each pouch represents textile waste diverted from landfills. Share the sustainability story with others!",
            image:
              "https://images.unsplash.com/photo-1531270165448-73e7ee678f2a",
          },
        ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section
        className="section-padding bg-section mt-16"
        style={{ marginTop: "0px" }}
      >
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {photoGallery.map((photo) => (
                  <div
                    key={photo.id}
                    className="bg-white rounded-lg overflow-hidden shadow-sm card-hover-lift"
                  >
                    <img
                      src={photo.url}
                      alt={photo.title}
                    ...
                    />
                    <div className="p-4">
                      <h3 className="body-medium font-semibold mb-2">
                        {photo.title}
                      </h3>
